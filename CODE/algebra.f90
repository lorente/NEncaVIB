...
CONTAINS
        ...
        if (INFO /= 0) then
                ...
                write (unit_screen,*) ' '
                write (unit_screen,*) 'factorization failed, INFO=', INFO
                write (unit_screen,*) 'in INVERSION subroutine; STOPPING' 
                write (unit_screen,*) ' '
                stop
        endif
        ...
        if (INFO /= 0) then
                ...
                print *, 'STOPPING'
                write (unit_screen,*) ' '
                write (unit_screen,*) 'inversion failed, INFO=', INFO
                write (unit_screen,*) 'STOPPING'
...
&           W, WORK, LWORK,RWORK,INFO)
       ...
       if ( INFO /= 0 ) then
         ...
         print *, 'but we continue the calculation.'
                write (unit_screen,*) ' '
         write (unit_screen,*) 'the diagonalization had problems'
         write (unit_screen,*) 'INFO =', INFO
         write (unit_screen,*) 'check your input data'
         write (unit_screen,*) 'but we continue the calculation.'
                write (unit_screen,*) ' '
